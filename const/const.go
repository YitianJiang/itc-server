...
const LARK_URL = "http://rocket.bytedance.net/api/v1/robot/person/send"

var LowLarkPeople = []string{"kanghuaisong", "fanjuan.xqp", "yinzhihong"}
var MiddleLarkPeople = []string{"kanghuaisong", "fanjuan.xqp", "yinzhihong", "zhangshuai.02"}
var HighLarkPeople = []string{"kanghuaisong", "fanjuan.xqp", "yinzhihong", "zhangshuai.02", "chenyujun"}

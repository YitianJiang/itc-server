...
const(
	...
	CSR_FILE_URL="http://tosv.byted.org/obj/staticanalysisresult/appleConnectFile/fullFileAccept/CertificateSigningRequest.certSigningRequest"
	APPLE_CREATE_CERT_URL="https://api.appstoreconnect.apple.com/v1/certificates"
	PRIVATE_KEY_URL="http://tosv.byted.org/obj/staticanalysisresult/appleConnectFile/fullFileAccept/bytedancett_ies_priv.p12"
	TOS_BUCKET_URL="http://tosv.byted.org/obj/staticanalysisresult/"
    Certain_Resource_All_PERMS_URL="http://10.224.13.176:6789/v1/config/permission/query/use/resource?"
	USER_ALL_RESOURCES_PERMS="http://10.224.13.176:6789/v1/config/permission/query/user/all?"

...
import (
	...
	"code.byted.org/trace/trace-client-go/jaeger-client/internal/baggage"
	"code.byted.org/trace/trace-client-go/jaeger-client/internal/throttler"
	"code.byted.org/trace/trace-client-go/jaeger-client/log"
...
func (t *Tracer) reportSpan(sp *Span) {
	...
	if sp.context.IsSampled() {
		// TODO(zhanggongyuan): comment this logger.Infof
		t.logger.Infof("span reporting: span-ctx: %s", sp.context.String())
